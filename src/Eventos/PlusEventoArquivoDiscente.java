...
public class PlusEventoArquivoDiscente extends EventosPadrao {
	...
	protected EventosCaixa evento;

	public PlusEventoArquivoDiscente(final Panel mainDialog, final EventosCaixa evento) {
		this.evento = evento;
