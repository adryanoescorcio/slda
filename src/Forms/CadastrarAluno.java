...
public class CadastrarAluno extends TelaPadrao{
	...
	public CadastrarAluno() {
		...
		JPanel linha2L = criarDividirEConfigurarCelula(new JLabel("  Matrícula:"), tff1);
		...
		JPanel linha12 = criarDividirEConfigurarCelula(botao, new Label(""));
		...
		add(new Label(""));					add(linha2L);										add(linha2R);				add(new Label(""));
