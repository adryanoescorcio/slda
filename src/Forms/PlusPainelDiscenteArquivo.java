...
import Eventos.PlusEventoDiscenteArquivo;
import Eventos.EventosAluno;

public class PlusPainelDiscenteArquivo extends PlusEventoDiscenteArquivo {
	...
	public static void setMainDialog(JPanel mainDialog) {
		PlusPainelDiscenteArquivo.mainDialog = mainDialog;
	}
