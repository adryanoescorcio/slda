...
public class ExcluirAluno extends JPanel{

	JButton botaoExcluir;
	JButton botaoBuscar;
	JFormattedTextField tff1 = new JFormattedTextField();
	JFormattedTextField tff2 = new JFormattedTextField();
	JFormattedTextField tff3 = new JFormattedTextField();
	JFormattedTextField tff4 = new JFormattedTextField();
	JFormattedTextField tff5 = new JFormattedTextField();
	JFormattedTextField tff6 = new JFormattedTextField();
	...
	JRadioButton radioF = new JRadioButton("F");
	...
	public ExcluirAluno() {
		...
		linha12.add(botaoExcluir);								linha12.add(new Label(""));										
